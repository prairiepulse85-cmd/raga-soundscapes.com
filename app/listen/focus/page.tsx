...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Indian Classical Music for Focus & Deep Work | Raga Soundscapes',
    description: 'Ragas for concentration, creative work, and deep focus. Yaman, Bihag, Kafi, Bhimpalasi.',
...
const schema = {
  ...
  url: 'https://ragasoundscapes.com/listen/focus',
  description: 'Indian classical ragas for concentration, creative work, and deep focus.',
  breadcrumb: {
    '@type': 'BreadcrumbList',
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://ragasoundscapes.com' },
      { '@type': 'ListItem', position: 2, name: 'Ragas for Focus & Deep Work', item: 'https://ragasoundscapes.com/listen/focus' },
    ],
  },
}
    ...
    <>
      ...
      <main className="max-w-[720px] mx-auto px-6 bg-rs-bg">
        ...
        <div className="text-[15px] font-[family-name:var(--font-dm-sans)] text-rs-muted leading-[1.85] mb-10 space-y-4">
          <p>Not all meditation is stillness. Some of the most effective Indian classical ragas for concentration are evening and night ragas — their moderate brightness and emotional warmth hold the mind attentive without agitation. Yaman opens the evening with clarity and grandeur. Bihag is warm and intimate. Kafi has a folk accessibility that makes it easy to work alongside.</p>
          <p>These soundscapes are designed for extended listening — for creative work, deep study, or any task that requires the mind to be present without being stimulated. They are instrumental, uninterrupted, and long enough to settle into.</p>
        </div>
