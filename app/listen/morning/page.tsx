...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Ragas for Morning Meditation — Indian Classical Music | Raga Soundscapes',
    description: 'Morning ragas from the Hindustani classical tradition — Bhairav, Lalit, Todi, Ahir Bhairav.',
...
const schema = {
  ...
  url: 'https://ragasoundscapes.com/listen/morning',
  description: 'Morning ragas from the Hindustani classical tradition for meditation and yoga.',
  breadcrumb: {
    '@type': 'BreadcrumbList',
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://ragasoundscapes.com' },
      { '@type': 'ListItem', position: 2, name: 'Ragas for Morning Meditation', item: 'https://ragasoundscapes.com/listen/morning' },
    ],
  },
}
    ...
    <>
      ...
      <main className="max-w-[720px] mx-auto px-6 bg-rs-bg">
        ...
        <div className="text-[15px] font-[family-name:var(--font-dm-sans)] text-rs-muted leading-[1.85] mb-10 space-y-4">
          <p>The earliest ragas in the Hindustani tradition are not simply slow or quiet — they are architecturally designed for the pre-dawn and morning hours. Bhairav carries the gravity and devotion of the moment before sunrise. Lalit holds the mystical darkness of 4am. Todi turns the mind inward in a way that no afternoon raga can.</p>
          <p>These soundscapes are built for morning meditation, pranayama, slow yoga, or simply as a way to inhabit the first hour of the day with intention. The raga you choose will shape the emotional register of your morning.</p>
        </div>
