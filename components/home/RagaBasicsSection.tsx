  ...
  return (
    <section id="raga-basics" className="rs-section" style={{ background: 'var(--rs-surface2)', borderTop: '1px solid var(--rs-border)', borderBottom: '1px solid var(--rs-border)' }}>
      <div className="rs-container">
        ...
        <h2 className="rs-section-title" style={{ fontSize: '28px', marginBottom: '16px' }}>Raga basics, explained gently</h2>
        <p style={{ maxWidth: '680px', margin: '0 auto 40px', textAlign: 'center', fontSize: '14px', color: 'var(--rs-muted)', lineHeight: 1.8, fontFamily: 'var(--font-dm-sans), sans-serif' }}>
        ...
        <div style={{
          ...
          {TERMS.map((item) => (
            <article key={item.term} className="rs-grid-card" style={{ padding: '22px 20px' }}>
              <h3 style={{ color: 'var(--rs-text)', fontSize: '16px', marginBottom: '8px', fontFamily: 'var(--font-cinzel), serif' }}>
                {item.term}
              </h3>
              <p style={{ color: 'var(--rs-muted)', fontSize: '12px', lineHeight: 1.65, fontFamily: 'var(--font-dm-sans), sans-serif' }}>
                {item.meaning}
              </p>
            </article>
          ))}
