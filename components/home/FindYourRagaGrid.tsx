        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[12px]">
          {CARDS.map((card) => (
            <Link key={card.href} href={card.href} className="block group">
              <div className="min-h-[200px] flex flex-col justify-between bg-white border-[0.5px] border-[#E4D8C0] border-t-2 border-t-[#C8A830] rounded-[2px] px-[22px] py-[20px] shadow-[0_1px_6px_rgba(18,33,58,0.08)] transition-shadow duration-200 ease-in-out hover:shadow-[0_2px_12px_rgba(18,33,58,0.12)]">
                <div>
